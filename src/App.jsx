  ...
  return (
    <div id="why" className="space-y-6">
      <p
        ...
        dangerouslySetInnerHTML={formatInline(strings.why.lead)}
      />
      <p
        className="text-sm text-gray-700"
        dangerouslySetInnerHTML={formatInline(strings.why.body)}
      />
      <ul className="grid gap-3 sm:grid-cols-3">
        {strings.why.bullets.map((b) => (
          <li
            ...
            dangerouslySetInnerHTML={formatInline(b)}
          />
        ))}
      </ul>
      <a
    ...
    <div className="grid gap-10 md:grid-cols-2">
      ...
      <div className="grid content-start gap-4">
        {pillars.map((p, i) => (
          <div
            key={p}
            className="flex items-start gap-4 rounded-2xl border border-black/10 bg-white p-5 shadow-[0_1px_0_rgba(0,0,0,0.05)]"
          >
            ...
            <p
              ...
              dangerouslySetInnerHTML={formatInline(p)}
            />
          </div>
        ))}
      </div>
      ...
      case "linkedin":
        return (
          <svg
            ...
            aria-hidden
          >
            <path d="M4.98 3.5C4.98 4.88 3.86 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM0 8h5v16H0zM9 8h4.8v2.2h.07c.67-1.2 2.3-2.47 4.73-2.47C22.4 7.73 24 10 24 13.6V24h-5v-8.6c0-2.05-.04-4.69-2.86-4.69-2.86 0-3.3 2.23-3.3 4.54V24H9z" />
          </svg>
        );
      case "x":
        return (
          <svg
            ...
            aria-hidden
          >
            <path d="M18.244 2H21l-6.79 7.74L22 22h-5.82l-4.55-5.9L6.2 22H3.44l7.25-8.27L2 2h5.94l4.1 5.47L18.24 2zM8.24 4H6.08l9.78 13.11h2.23L8.24 4z" />
          </svg>
        );
      case "instagram":
        return (
          <svg
            ...
            aria-hidden
          >
            <path d="M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5zm0 2a3 3 0 00-3 3v10a3 3 0 003 3h10a3 3 0 003-3V7a3 3 0 00-3-3H7zm5 3a5 5 0 110 10 5 5 0 010-10zm0 2.2a2.8 2.8 0 100 5.6 2.8 2.8 0 000-5.6zM18.5 5.5a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z" />
          </svg>
        );
      case "youtube":
        return (
          <svg
            ...
            aria-hidden
          >
            <path d="M23.5 6.2a3 3 0 00-2.1-2.1C19.7 3.5 12 3.5 12 3.5s-7.7 0-9.4.6A3 3 0 00.5 6.2C0 7.9 0 12 0 12s0 4.1.5 5.8a3 3 0 002.1 2.1c1.7.6 9.4.6 9.4.6s7.7 0 9.4-.6a3 3 0 002.1-2.1c.5-1.7.5-5.8.5-5.8s0-4.1-.5-5.8zM9.6 15.5V8.5l6.3 3.5-6.3 3.5z" />
          </svg>
        );
      case "facebook":
        return (
      ...
      case "tiktok":
        return (
          <svg
            ...
            aria-hidden
          >
            <path d="M12 2h3.5c.3 2.1 1.6 3.9 3.5 4.9v3.3c-1.4-.03-2.8-.4-4-1.1v5.6c0 3.7-3 6.7-6.7 6.7S1.6 18.4 1.6 14.7s3-6.7 6.7-6.7c.4 0 .8 0 1.2.1v3.3c-.4-.1-.8-.2-1.2-.2-1.9 0-3.4 1.5-3.4 3.5s1.5 3.5 3.4 3.5 3.4-1.5 3.4-3.5V2z" />
          </svg>
        );
      default:
        return null;
              ...
              {socials
                ...
                .map((s) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center justify-center rounded-full border border-black/10 p-2 text-gray-700 hover:bg-gray-50 hover:text-black"
                  >
                    <Icon kind={s.kind} />
                  </a>
                ))}
...
function ExcerptModal({ open, onClose, lang }) {
  ...
  const onSubmit = async (e) => {
    ...
    if (!ok) {
      setMessage(
        t("Merci d’entrer un email valide.", "Please enter a valid email.")
      );
      setStatus("error");
      return;
    }
      ...
      >
        <div className="flex items-start justify-between">
          <h3 className="text-lg font-semibold text-gray-900">
            {t("Télécharger un extrait", "Download an excerpt")}
          </h3>
          <button
            onClick={onClose}
        ...
        <form className="mt-4 grid gap-3" onSubmit={onSubmit}>
          ...
          >
            {status === "loading"
              ? t("Envoi…", "Sending…")
              : t("Envoyer le lien", "Send the link")}
          </button>
          {message && (
            <div
              className={`text-xs ${
