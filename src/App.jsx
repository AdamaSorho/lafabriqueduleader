  ...
  return (
    <div className="grid gap-6 md:grid-cols-3">
      {quotes.map((q, i) => (
        ...
        >
          <div className="mb-3 flex items-center gap-1 text-[--accent]" aria-hidden>
            {[0,1,2,3,4].map((s) => (
              <svg key={s} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-4">
