...
function Footer({ strings }) {
  ...
  const Icon = ({ kind }) => {
    ...
    switch (kind) {
      ...
      case "tiktok":
        return (
          <svg className={cls} viewBox="0 0 24 24" fill="currentColor" aria-hidden><path d="M12 2h3.5c.3 2.1 1.6 3.9 3.5 4.9v3.3c-1.4-.03-2.8-.4-4-1.1v5.6c0 3.7-3 6.7-6.7 6.7S1.6 18.4 1.6 14.7s3-6.7 6.7-6.7c.4 0 .8 0 1.2.1v3.3c-.4-.1-.8-.2-1.2-.2-1.9 0-3.4 1.5-3.4 3.5s1.5 3.5 3.4 3.5 3.4-1.5 3.4-3.5V2z"/></svg>
        )
      default:
        return null
    }
