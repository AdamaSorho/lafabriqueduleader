...
export default function CTA({ strings, onOpenExcerpt }) {
  return (
    <section className="relative isolate mx-4 my-20 rounded-3xl bg-gray-900 px-6 py-14 text-white sm:mx-auto sm:max-w-7xl sm:px-12">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          <a href={orderUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center rounded-full bg-white px-5 py-3 text-sm font-semibold text-gray-900 hover:bg-gray-100">{strings.finalCta.ctas.preorder}</a>
